...
window.Empire.Map = (() => {
  ...
  function generateCity() {
    ...
    window.Empire.districts = city.districts;
  }
  ...
  function updateTooltip(district, clientX, clientY) {
    ...
    state.tooltip.innerHTML = `
      ...
      Typ: ${district.type}<br/>
      Vlastník: ${district.owner || "Neobsazeno"}<br/>
      Příjem: $${district.income}/hod<br/>
      Vliv: ${district.influence}
    `;
  ...
  function setDistricts(districts) {
    ...
    const normalized = districts.map((district, index) => ({
      id: district.id,
